...
import (
	...
	"github.com/as/shiny/sys/windows/svc"
	"github.com/as/shiny/sys/windows/svc/mgr"
)
...
func TestExample(t *testing.T) {
	...
	o, err := exec.Command("go", "build", "-o", exepath, "github.com/as/shiny/sys/windows/svc/example").CombinedOutput()
	if err != nil {
